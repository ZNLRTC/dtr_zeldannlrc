...
<body>
    ...
    <?php 
        ...
        $this->load->view('partials/modal/update-password-modal');
        $this->load->view('partials/modal/dtr-cru-modal');
        $this->load->view('partials/modal/log-out-modal');
        $this->load->view('partials/modal/cancel-ongoing-dtr-modal');
    ?>
    <!-- JQUERY -->
