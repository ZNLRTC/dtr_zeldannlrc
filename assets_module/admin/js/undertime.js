$(function () {
    ...
    (function (app) {
        ...
        app.undertimeLogsTable = function(){
            undertimeLogsTable = $('#undertime-list-table').DataTable({
                bLengthChange: false,
                searching: true,
                info: false,
                iDisplayLength: -1,
            ...
            $('#employee-undertime-table-search').keyup(function () {
                undertimeLogsTable.search($(this).val()).draw();
            });
        }
